...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BRIG features */
        {"brig", "masternode", &masternode, true, true, false},
        {"brig", "masternodelist", &masternodelist, true, true, false},
        {"brig", "mnbudget", &mnbudget, true, true, false},
        {"brig", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"brig", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"brig", "mnsync", &mnsync, true, true, false},
        {"brig", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"brig", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use brigd, or the -server option to brig-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> brig-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25312/\n";
}
