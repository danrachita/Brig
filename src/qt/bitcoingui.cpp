                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Brig-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Brig address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and brig: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Brig Core"), this);
    aboutAction->setStatusTip(tr("Show information about Brig Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Brig"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Brig addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Brig addresses"));
    ...
    openAction->setStatusTip(tr("Open a Brig: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Brig Core help message to get a list with possible Brig command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Brig Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Brig network", "", count));
}
...
{
    QString strTitle = tr("Brig Core"); // default title
