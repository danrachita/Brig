...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000868c2fc191cfc51d1f80126f5f02cc425f713b7935bc2e0a56dfe06e05b"))
    (182054, uint256("0x31a06ad93fde3e0651889b8aa81da59b8c719457718136c26e8e5e404161002b"))
    (377187, uint256("0xf833ec10c370a0341cbfd36bc6b9535ddf13fe15ebf0cb75a87dc1756f121373"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1550413206, // * UNIX timestamp of last checkpoint block
    767630,    // * total number of transactions between genesis and last checkpoint
...
public:
	...
	nMasternodeColleteralLimxDev = 6000; //Params().MasternodeColleteralLimxDev()
        ...
        nMaxMoneyOut = 450000000 * COIN;

        const char* pszTimestamp = "Brig cryptocurrency";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1527482547;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21192145;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x00000868c2fc191cfc51d1f80126f5f02cc425f713b7935bc2e0a56dfe06e05b"));
        assert(genesis.hashMerkleRoot == uint256("0x7c4fc21a06d9a4e89fab8f7fb378ac3b03b73453955be95c0cc7b20e8617eb92"));
	...
	vSeeds.push_back(CDNSSeedData("104.248.244.214", "104.248.244.214"));
        ...
        nStartMasternodePayments = 1527482547; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1527482548;
        genesis.nNonce = 21604720;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000dc087a90d465ea560427b6207d7b4dd982deaa54ba398c4a5c0546593db"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Brig BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Brig BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Brig BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1527482548;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1527482549;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 4;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x1161cdcaefd198b6862f7f6000c086386855933e7488f5ae5a5b95422ad516ee"));
