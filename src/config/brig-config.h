/* src/config/brig-config.h.  Generated from brig-config.h.in by configure.  */
/* src/config/brig-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BRIG_CONFIG_H

#define BRIG_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://brig.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Brig Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Brig Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "brig"
