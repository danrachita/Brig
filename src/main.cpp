...
#if defined(NDEBUG)
#error "Brig cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Brig Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 1) return 450000 * COIN;
		
	int64_t nSubsidy;
	
	if( nHeight > 1 && nHeight <= 3500 ) {
	        nSubsidy = 1 * COIN;
	} else if( nHeight > 3500 && nHeight <= 8000 ) {
	        nSubsidy = 50 * COIN;
	        ...
	        nSubsidy = 280 * COIN;
	} else if( nHeight > 40000 && nHeight <= 350000 ) {
	        nSubsidy = 100 * COIN;
