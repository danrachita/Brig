...
RESOURCES += src/qt/brig.qrc src/qt/brig_locale.qrc

TRANSLATIONS += src/qt/locale/brig_bg.ts \
                src/qt/locale/brig_de.ts \
                src/qt/locale/brig_en.ts \
                src/qt/locale/brig_es.ts \
                src/qt/locale/brig_fi.ts \
                src/qt/locale/brig_fr.ts \
                src/qt/locale/brig_it.ts \
                src/qt/locale/brig_ja.ts \
                src/qt/locale/brig_pl.ts \
                src/qt/locale/brig_pt.ts \
                src/qt/locale/brig_ru.ts \
                src/qt/locale/brig_sk.ts \
                src/qt/locale/brig_sv.ts \
                src/qt/locale/brig_vi.ts \
                src/qt/locale/brig_zh_CN.ts \
                src/qt/locale/brig_zh_TW.ts
